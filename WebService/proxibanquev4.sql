...
create table gerant
(loginger varchar(30) constraint pk_logger primary key,
password varchar(5) UNIQUE,
prenomger varchar(20),
nomger varchar(20));
...
( logincons  	  varchar(30) constraint pk_logcons primary key, 
  ...
  nomcons         varchar(20),
  loginger    	  varchar(30) constraint fk_loggercons references gerant(loginger));
...
delete from GERANT;
insert into gerant values ('jchirac','popo','Jacques','Chirac'); 
insert into gerant values ('emacron','pupu','Emmanuel','Macron');
insert into gerant values ('fhollande','papa','Francois','Hollande');

Prompt INSERTION DANS CONSEILLER

DELETE FROM CONSEILLER;
insert into conseiller values ('pdupond','toto','Paul','Dupond','jchirac'); 
insert into conseiller values ('jfontaine','tutu','Jean','Fontaine','emacron');
insert into conseiller values ('rhoareau','titi','Remi','Hoareau','fhollande');
insert into conseiller values ('psanchez','tata','Pierre','Sanchez','jchirac');
insert into conseiller values ('pierre.sanchez','tyty','Pierre','Sanchez','fhollande');
...
insert into client values(1,'Richard','FOSTER','9 RUE DU LAC',45900,'LA SOURCE','0302345698','r.foster@forbes.com','pdupond');
insert into client values(2,'Jean-Filipo ','DE LATTRE DE FRANCE','13 AVENUE DES TILLEULS',92310,'SEVRES','0134568934',null,'jfontaine');
insert into client values(3,'Paul','PRAT','89 RUE DES CHEVREAUX',33000,'BORDEAUX','0455237806','p.prat@oticien.com','jfontaine');
insert into client values(4,'Lucien','VIGOT','78 RUE EISENBERG',75005,'PARIS','0126597820',null,'psanchez');
insert into client values(5,'Hattmann','BELLEUS','15 RUE DE LA BOHEME',75007,'PARIS','0135678712','h.belleus@gmail.com','pierre.sanchez');
insert into client values(6,'Loriane','EYMANN','13 AVENUE DES TILLEULS',92310,'SEVRES','0134568934',null,'psanchez');
insert into client values(7,'Stanislas','DESORGES','60 RUE DE BIARRITZ',13008,'MARSEILLE','0456788932','desorges@desorges.fr','rhoareau');
insert into client values(8,'John','SMITH','SQUARE DU PETIT MARIN',13008,'MARSEILLE','0356999013','jsmith@hotmail.fr','psanchez');
insert into client values(9,'Albert','MOUNIER','126 RUE DES MARINS',29000,'BREST','0302345698','a.mounier@hsbc.com','pdupond');
insert into client values(10,'Paul','MOULIN','13 AVENUE DES TILLEULS',94000,'CRETEIL','0134568934',null,'jfontaine');
insert into client values(11,'Paul','PRAT','89 RUE DES CHEVREAUX',33000,'BORDEAUX','0455237806','p.prat@oticien.com','jfontaine');
insert into client values(12,'Lucien','VIGOT','78 RUE EISENBERG',75005,'PARIS','0126597820',null,'psanchez');
insert into client values(13,'Hattmann','BELLEUS','15 RUE DE LA BOHEME',75007,'PARIS','0135678712','h.belleus@gmail.com','pierre.sanchez');
insert into client values(14,'Loriane','EYMANN','13 AVENUE DES TILLEULS',92310,'SEVRES','0134568934',null,'psanchez');
insert into client values(15,'Stanislas','DESORGES','60 RUE DE BIARRITZ',13008,'MARSEILLE','0456788932','desorges@desorges.fr','rhoareau');
insert into client values(16,'John','SMITH','SQUARE DU PETIT MARIN',13008,'MARSEILLE','0356999013','jsmith@hotmail.fr','psanchez');
