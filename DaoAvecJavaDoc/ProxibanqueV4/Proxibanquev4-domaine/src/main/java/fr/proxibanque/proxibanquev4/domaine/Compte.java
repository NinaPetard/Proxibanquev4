 ...
 * un taux de rénumération TAUXREM (concerne les comptes épargnes) et un Client.
...
public class Compte implements Serializable {
    ...
    public Compte(int numcompte, Date dateouv, int solde, double tauxrem, Client idcli) {
		super();
	...
	public Compte(int numcompte, Date dateouv, int solde, Integer decouvert, Client idcli) {
		super();
		this.numcompte = numcompte;
		this.dateouv = dateouv;
		this.solde = solde;
