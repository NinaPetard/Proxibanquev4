...
/**
 * @author Victor 
 * La classe Gérant permet l'instanciation des objets Gérant avec comme attribut un IDGer (unique), un loginger (unique), 
 ...
 * Cette classe est une "entity class" et va permettre la persistence en base de données d'un gérant.
 */
@Entity
@Table(name = "GERANT")
@XmlRootElement
